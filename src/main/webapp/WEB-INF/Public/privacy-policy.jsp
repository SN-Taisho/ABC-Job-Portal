...
<main class="public limited justify-center">
	...
	<div class="pub-card" style="align-items: start;">
		<span class="pub-date">Last Updated: Aug 3, 2023</span>
		<h3 class="pub-heading">Privacy Policy</h3>

		<p class="pub-paragraph">Welcome to ABC Job Portal, we value your
			trust and understand the importance of protecting your personal
			information. On this page are outlines of how we collect, use, share,
